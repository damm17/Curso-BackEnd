...
app.get("/", (req, res) => {
    try {
        ...
        res.render("pages/index", { savedProduct })
    } catch (error) {
        console.log(error)
    }
})
...
router.get('/productos/vista', (req,res)=>{
    try {
        ...
        res.render("pages/products", { products, productsAvailable: req.session.productsAvailable })
    } catch (error) {
        console.log(error)
    }
});
...
router.get('/productos/listar/:id', (req,res)=>{
    try {
        ...
        res.render("pages/products", { product, productsAvailable: req.session.productsAvailable, products: null })
    } catch (error) {
        console.log(error)
    }
});
