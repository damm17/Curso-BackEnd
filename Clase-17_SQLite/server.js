...
import { config, __dirname } from "./src/environment/config.js";
...
io.on('connection', (socket) => {
    ...
    fs.readFile(`${__dirname}/logs/chat.json`, 'utf8', (err, data) => {
        if (!err) {
    ...
    socket.on('chatMsg', (data) => {
        ...
        fs.writeFile(`${__dirname}/logs/chat.json`, JSON.stringify(chats, null, "\t"), 'utf8', (err, data) => {
            if (!err) {
